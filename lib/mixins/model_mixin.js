...
function unserialize(data, cb) {
  var marshaller = marshallers.createInstance(this.model.orm.marshaller);
  cb(null, marshaller.unserializeData(data, this.model.propertyTypes));
}

function serialize(data) {
  var marshaller = marshallers.createInstance(this.model.orm.marshaller);
  return marshaller.serializeData(data, this.model.propertyTypes);
}
