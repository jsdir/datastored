...
exports.Core = {
  input: function(data, options) {
    return filterAttributes(this, data, function(attribute) {
      return !(options.user && attribute.guarded);
    });
  },
...
exports.AssociationLinks = {
  save: function(data, options, cb) {
    // Check where the changed attributes are joined.
    var self = this;
    async.each(this.model._linkTriggers, function(func, cb) {
      func(self, data, cb);
    }, cb);
  }
};
