 ...
 *   attribute: (name, value, options, applyUserTransforms, cb)
 *
  ...
  return _.reduce(mixins, function(result, mixin) {
    ...
    compose('output', function(func1, func2) {
      return function(data, options, applyUserTransforms) {
        return func1.bind(this)(func2.bind(this)(data, options, applyUserTransforms), options, applyUserTransforms);
      }
    });

    compose('outputAsync', async.compose, true);

    compose('fetch', function(func1, func2) {
      return function(data, options, cb) {
        var self = this;
        func2.bind(self)(data, options, function(err, result) {
          if (err) {return cb(err);}
          func1.bind(self)(result, options, cb);
        })
      }
    });
